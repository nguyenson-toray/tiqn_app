...
frappe.query_reports["Vegetarian Meal - List Register"] = {
	"filters": [
		{
			"fieldname": "from_date",
			"label": __("From Date"),
	...
	onload: function (report) {
		...
		frappe.call({
			method: "tiqn_app.tiqn_app.report.vegetarian_meal___list_register.vegetarian_meal___list_register.get_groups",
			callback: function (r) {
				if (!r.exc && r.message) {
					let options = [""];
